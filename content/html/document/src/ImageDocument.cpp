...
protected:
  ...
  float GetShrinkToFitRatio() {
    return NS_MIN(mVisibleWidth / mImageWidth,
...
ImageDocument::ShrinkToFit()
{
  ...
  image->SetWidth(NS_MAX(1, NSToCoordFloor(GetShrinkToFitRatio() * mImageWidth)));
  image->SetHeight(NS_MAX(1, NSToCoordFloor(GetShrinkToFitRatio() * mImageHeight)));
