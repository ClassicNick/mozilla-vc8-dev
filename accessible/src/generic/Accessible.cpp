...
{
  MOZ_STATIC_ASSERT(eLastChildrenFlag <= (1 << kChildrenFlagsBits) - 1,
                "Accessible::mChildrenFlags was oversized by eLastChildrenFlag!");
  MOZ_STATIC_ASSERT(eLastStateFlag <= (1 << kStateFlagsBits) - 1,
                "Accessible::mStateFlags was oversized by eLastStateFlag!");
  MOZ_STATIC_ASSERT(eLastAccType <= (1 << kTypeBits) - 1,
                "Accessible::mType was oversized by eLastAccType!");
  MOZ_STATIC_ASSERT(eLastContextFlag <= (1 << kContextFlagsBits) - 1,
                "Accessible::mContextFlags was oversized by eLastContextFlag!");
  MOZ_STATIC_ASSERT(eLastAccGenericType <= (1 << kGenericTypesBits) - 1,
