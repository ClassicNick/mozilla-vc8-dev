...
class HashMap
{
  ...
  public:
    ...
    bool init(uint32 len = detail::HashTable<Entry, MapHashPolicy, AllocPolicy>::sDefaultInitSize)    { return impl.init(len); }
...
class HashSet
{
  ...
  public:
    ...
    bool init(uint32 len = detail::HashTable<const T, SetOps, AllocPolicy>::sDefaultInitSize)    { return impl.init(len); }
    bool initialized() const                          { return impl.initialized(); }
