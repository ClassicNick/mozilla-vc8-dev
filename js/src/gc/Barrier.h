...
class HeapPtr : public BarrieredPtr<T, Unioned>
{
  ...
  private:
    /* The default move construction and assignment operators would be incorrect. */
	  HeapPtr(mozilla::MoveRef<HeapPtr<T> >) MOZ_DELETE;
	  HeapPtr<T, Unioned> &operator=(mozilla::MoveRef<HeapPtr<T, Unioned> >) MOZ_DELETE;
};
...
class HeapValue : public BarrieredValue
{
  ...
  private:
    ...
    /* The default move construction and assignment operators would be incorrect. */
	HeapValue(mozilla::MoveRef<HeapValue>) MOZ_DELETE;
	HeapValue &operator=(mozilla::MoveRef<HeapValue>) MOZ_DELETE;
};
...
class HeapId : public BarrieredId
{
  ...
  private:
    ...
    /* The default move construction and assignment operators would be incorrect. */
	HeapId(mozilla::MoveRef<HeapId>) MOZ_DELETE;
	HeapId &operator=(mozilla::MoveRef<HeapId>) MOZ_DELETE;
};
