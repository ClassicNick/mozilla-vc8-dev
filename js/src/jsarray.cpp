...
array_length_setter(JSContext *cx, HandleObject obj, HandleId id, bool strict, MutableHandleValue vp)
{
    ...
    ArraySetLength<SequentialExecution>(cx, arr, id, JSPROP_PERMANENT, vp, strict);
}
...
bool
js::CanonicalizeArrayLengthValue(JSContext* cx,
...
template <ExecutionMode mode>
bool
js::ArraySetLength(JSContext* cxArg,
...
js::ArraySetLength<SequentialExecution>(JSContext *cx, Handle<ArrayObject*> arr,
                                        ...
                                        bool setterIsStrict);
template bool
js::ArraySetLength<ParallelExecution>(JSContext *cx, Handle<ArrayObject*> arr,
                                      HandleId id, unsigned attrs, HandleValue value,
                                      bool setterIsStrict);
