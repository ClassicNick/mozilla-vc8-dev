...
inline bool
js::ObjectImpl::nativeContainsId(JSContext *cx, JS::Handle<jsid> id)
{
    return nativeLookup(cx, id) != NULL;
}

inline bool
js::ObjectImpl::nativeContainsName(JSContext *cx, JS::Handle<PropertyName*> name)
{
    return nativeLookup(cx, name) != NULL;
}

inline bool
js::ObjectImpl::nativeContainsShape(JSContext *cx, JS::Handle<Shape*> shape)
{
