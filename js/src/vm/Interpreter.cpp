...
bool
js::InvokeGetterOrSetter(JSContext *cx, JSObject *obj, const Value &fval, unsigned argc,
...
BEGIN_CASE(JSOP_INITPROP_SETTER)
{
    ...
    if (!InitGetterSetterOperation(cx, regs.pc, obj, (HandlePropertyName) name, val))
        goto error;
                              ...
                              HandlePropertyName name, HandleValue val)
{
    ...
    return InitGetterSetterOperation(cx, pc, obj, (HandleId) id, val);
}
