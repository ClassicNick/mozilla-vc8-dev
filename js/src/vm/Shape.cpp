...
GetOrLookupUnownedBaseShape(ExclusiveContext* cx,
                            StackBaseShape &base)
{
...
template <ExecutionMode mode>
/* static */ Shape *
JSObject::addPropertyInternal(js::ExclusiveContext* cx,
...
JSObject::addPropertyInternal<SequentialExecution>(js::ExclusiveContext* cx,
...
template <ExecutionMode mode>
/* static */ Shape *
JSObject::changeProperty(ExclusiveContext *cx,
