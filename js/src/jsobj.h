...
class JSObject : public js::ObjectImpl
{
  ...
  private:
    ...
    static inline js::Shape *
		getOrLookupChildProperty(js::ExclusiveContext* cx,
  ...
  protected:
    ...
    template <js::ExecutionMode mode>
    static js::Shape *
		addPropertyInternal(js::ExclusiveContext* cx,
  ...
  public:
    ...
    template <js::ExecutionMode mode>
    static js::Shape *
    putProperty(js::ExclusiveContext *cx,
                JS::HandleObject obj, JS::HandleId id,
                JSPropertyOp getter, JSStrictPropertyOp setter,
                uint32_t slot, unsigned attrs,
    ...
    template <js::ExecutionMode mode>
    static js::Shape *
    changeProperty(js::ExclusiveContext *cx,
  ...
  private:
    static void staticAsserts() {
        ...
        MOZ_STATIC_ASSERT(js::shadow::Object::MAX_FIXED_SLOTS == MAX_FIXED_SLOTS,
