...
nsFrameIterator::nsFrameIterator(nsPresContext* aPresContext, nsIFrame *aStart,
  ...
  , mType(aType)
{
	mFollowOOFs = (aFlags & nsFrameIterator::FrameIteratorFlags::FLAG_FOLLOW_OUT_OF_FLOW) != 0;
  mLockScroll = (aFlags & nsFrameIterator::FrameIteratorFlags::FLAG_LOCK_SCROLL) != 0;
  mVisual = (aFlags & nsFrameIterator::FrameIteratorFlags::FLAG_VISUAL) != 0;
