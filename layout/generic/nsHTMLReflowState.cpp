                                 ...
                                 nsIAtom* aFrameType)
{
  ...
  if (nsGkAtoms::tableRowGroupFrame == aFrameType ||
    ...
    ComputedPhysicalPadding().left = NS_MAX(0, nsLayoutUtils::
      ComputeCBDependentValue(aHorizontalPercentBasis,
                              stylePadding->mPadding.GetLeft()));
    ComputedPhysicalPadding().right = NS_MAX(0, nsLayoutUtils::
      ComputeCBDependentValue(aHorizontalPercentBasis,
                              stylePadding->mPadding.GetRight()));

    ComputedPhysicalPadding().top = NS_MAX(0, nsLayoutUtils::
      ComputeCBDependentValue(aVerticalPercentBasis,
                              stylePadding->mPadding.GetTop()));
    ComputedPhysicalPadding().bottom = NS_MAX(0, nsLayoutUtils::
      ComputeCBDependentValue(aVerticalPercentBasis,
