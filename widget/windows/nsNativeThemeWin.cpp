...
GetCheckboxMargins(HANDLE theme, HDC hdc)
{
	...
	nsUXThemeData::getThemeMargins(theme, hdc, MENU_POPUPCHECK, MCB_NORMAL,
...
{
    SIZE checkboxSize;
    nsUXThemeData::getThemePartSize(theme, hdc, MENU_POPUPCHECK, MC_CHECKMARKNORMAL,
...
{
    SIZE gutterSize;
    nsUXThemeData::getThemePartSize(theme, hdc, MENU_POPUPGUTTER, 0, nullptr, TS_TRUE, &gutterSize);

    SIZE checkboxBGSize(GetCheckboxBGBounds(theme, hdc));

    SIZE itemSize;
    nsUXThemeData::getThemePartSize(theme, hdc, MENU_POPUPITEM, MPI_NORMAL, nullptr, TS_TRUE, &itemSize);
...
RENDER_AGAIN:
  ...
  else if (aWidgetType == NS_THEME_MENUPOPUP)
  {
    ...
    SIZE borderSize;
    nsUXThemeData::getThemePartSize(theme, hdc, MENU_POPUPBORDERS, 0, nullptr, TS_TRUE, &borderSize);
  ...
  if (((aWidgetType == NS_THEME_CHECKBOX || aWidgetType == NS_THEME_RADIO) &&
    ...
    nsUXThemeData::drawThemeEdge(theme, hdc, RP_BAND, 0, &widgetRect, EDGE_ETCHED, BF_TOP, nullptr);
  }
           ...
           aWidgetType == NS_THEME_SCROLLBAR_THUMB_VERTICAL)
  {
    ...
    if (nsUXThemeData::getThemePartSize(theme, hdc, gripPart, state, nullptr, TS_TRUE, &gripSize) == S_OK &&
        nsUXThemeData::getThemeMargins(theme, hdc, part, state, TMT_CONTENTMARGINS, nullptr, &thumbMgns) == S_OK &&
                                  ...
                                  nsIntMargin* aResult)
{
  ...
  HRESULT res = nsUXThemeData::getThemeContentRect(theme, nullptr, part, state, &outerRect, &contentRect);
                                   ...
                                   nsIntMargin* aResult)
{
  ...
  {
    SIZE popupSize;
    nsUXThemeData::getThemePartSize(theme, nullptr, MENU_POPUPBORDERS, /* state */ 0, nullptr, TS_TRUE, &popupSize);
                                       ...
                                       nsIntSize* aResult, bool* aIsOverridable)
{
  ...
  *aIsOverridable = true;
  ...
  SIZE sz;
  nsUXThemeData::getThemePartSize(theme, hdc, part, state, nullptr, sizeReq, &sz);
  aResult->width = sz.cx;
