...
#if MOZ_WINSDK_VER >= MOZ_NTDDI_LONGHORN
// The following file calls some kernel32 functions
// only present in Windows Vista or later
...
// Effectively reverts Bug 784859 parts 1-6
