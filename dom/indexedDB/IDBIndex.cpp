...
GetKeyHelper::PackArgumentsForParentProcess(IndexRequestParams& aParams)
{
  ...
  mozilla::dom::indexedDB::ipc::GetKeyParams params;
...
GetKeyHelper::MaybeSendResponseToChildProcess(nsresult aResultCode)
{
  ...
  if (NS_FAILED(aResultCode)) {
    ...
    mozilla::dom::indexedDB::ipc::GetKeyResponse getKeyResponse;
...
GetHelper::PackArgumentsForParentProcess(IndexRequestParams& aParams)
{
  ...
  mozilla::dom::indexedDB::ipc::FIXME_Bug_521898_index::GetParams params;
...
{
  mozilla::dom::indexedDB::ipc::GetAllKeysParams params;

  if (mKeyRange) {
    mozilla::dom::indexedDB::ipc::FIXME_Bug_521898_index::KeyRange keyRange;
...
GetAllKeysHelper::MaybeSendResponseToChildProcess(nsresult aResultCode)
{
  ...
  if (NS_FAILED(aResultCode)) {
    ...
    mozilla::dom::indexedDB::ipc::GetAllKeysResponse getAllKeysResponse;
...
{
  mozilla::dom::indexedDB::ipc::FIXME_Bug_521898_index::GetAllParams params;
...
{
  mozilla::dom::indexedDB::ipc::OpenKeyCursorParams params;
...
OpenKeyCursorHelper::MaybeSendResponseToChildProcess(nsresult aResultCode)
{
  ...
  if (NS_FAILED(aResultCode)) {
    ...
    if (!mCursor) {
      ...
      mozilla::dom::indexedDB::ipc::IndexCursorConstructorParams params;
...
{
  mozilla::dom::indexedDB::ipc::FIXME_Bug_521898_index::OpenCursorParams params;
...
{
  mozilla::dom::indexedDB::ipc::FIXME_Bug_521898_index::CountParams params;
